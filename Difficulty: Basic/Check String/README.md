<h2><a href="https://www.geeksforgeeks.org/problems/check-string1818/1?page=3&category=Strings,Java&difficulty=Basic,Easy&status=unsolved&sortBy=submissions">Check String</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string, check if all its characters are the same or not.</span></p>
