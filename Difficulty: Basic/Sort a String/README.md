<h2><a href="https://www.geeksforgeeks.org/problems/sort-a-string2943/1?page=3&category=Strings,Java&difficulty=Basic,Easy&status=unsolved&sortBy=submissions">Sort a String</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string consisting of lowercase letters, arrange all its letters in ascending order.&nbsp;</span></p>
